...
ROOT_URLCONF = 'voice_pay_backend.urls'
...
WSGI_APPLICATION = 'voice_pay_backend.wsgi.application'


# =========================
# DATABASE
# =========================
# Render recommends using DATABASE_URL for Postgres.
# This falls back to SQLite locally if DATABASE_URL is not set.
DATABASES = {
